...
def register_goal_example_envs():
    ...
    register(
        id='BaseSawyerPushMultiGoalCurriculumEnv-v0',
        entry_point='multiworld.envs.mujoco.sawyer_xyz.sawyer_push_nips:SawyerPushAndReachXYEasyEnv',
        tags={
            'git-commit-hash': 'TODO',
            'author': 'avi'
    ...
    register(
        id='Image48SawyerPushMultiGoalCurriculumEnv-v0',
        entry_point=create_image_48_sawyer_push_multi_goal_curriculum_v0,
        tags={
            'git-commit-hash': 'TODO',
            'author': 'avi'
        },
...
def create_image_48_sawyer_push_multi_goal_curriculum_v0():
    from multiworld.core.image_env import ImageEnv
    from multiworld.envs.mujoco.cameras import sawyer_pusher_camera_upright_v2
    wrapped_env = gym.make('BaseSawyerPushMultiGoalCurriculumEnv-v0')
    imsize = 48
    image_env = ImageEnv(
                wrapped_env=wrapped_env,
                imsize=imsize,
...
def create_state_sawyer_door_hook_multi_goal_v0():
    from multiworld.core.image_env import ImageEnv
